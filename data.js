...
// ========== QUESTIONS AJOUTÉES EN FORMATION 15/05/2026 ==========

const questionsFormation = [
  {
    theme: "UV 3 · Tenue et présentation",
    q: "Un APS peut, avec autorisation du préfet et accord de la personne concernée, faire :",
    options: [
      "Une fouille à corps d'une personne",
      "La fouille des bagages",
      "Un contrôle d'identité avec vérifications",
      "Aucune des réponses précédentes"
    ],
    correct: 3,
    explanation: "Aucune de ces actions n'est légalement permise à un APS, même avec autorisation préfectorale et consentement. La fouille à corps et le contrôle d'identité avec vérifications sont des prérogatives exclusives des OPJ. La fouille des bagages n'est possible qu'avec consentement explicite dans un cadre légal précis (art. L613-3 CSI), mais pas avec vérification d'identité."
  },
  {
    theme: "UV 5 · Incendie",
    q: "La propagation de l'incendie par la montée des gaz chauds et fumées correspond à :",
    options: [
      "La conduction",
      "La convection",
      "Le rayonnement",
    ...
    correct: 1,
    explanation: "La convection est le mode de propagation par déplacement de fluides (gaz chauds, fumées) qui montent et se déplacent horizontalement. La conduction = transmission par contact direct entre solides. Le rayonnement = transmission par ondes infrarouges sans contact. La projection = envoi de matières enflammées."
  },
  {
    theme: "UV 3 · Tenue et présentation",
    q: "Le port de la tenue par un APS est obligatoire :",
    options: [
      "FAUX",
      "VRAI"
    ],
    correct: 1,
    explanation: "VRAI. Le port de la tenue professionnelle est obligatoire pour tout APS en mission. Elle doit comporter le logo de l'entreprise de sécurité et permettre l'identification immédiate de l'agent. C'est une obligation réglementaire prévue par le Code de la sécurité intérieure."
  },
  {
    theme: "UV 3 · Tenue et présentation",
    q: "Combien de LOGOS d'entreprise de sécurité doivent être apposés sur l'uniforme d'un APS ?",
    options: [
      "Maximum 4",
      "Minimum 1",
    ...
    correct: 1,
    explanation: "La réglementation impose minimum 1 logo de l'entreprise de sécurité sur l'uniforme de l'APS, visible et lisible. Ce logo permet d'identifier l'employeur et de distinguer l'agent des forces de l'ordre."
  },
  {
    theme: "UV 5 · Incendie",
    q: "En IGH, quelles sont les différentes solutions de désenfumage ?",
    options: [
      "2 moteurs et 5 moteurs",
      "3 moteurs ou 5 moteurs",
      "Naturel – mécanique",
      "3 moteurs et 7 moteurs"
    ],
    correct: 1,
    explanation: "En IGH (Immeuble de Grande Hauteur), le désenfumage mécanique peut être assuré par 3 moteurs (solution minimale) ou 5 moteurs (solution renforcée). Le désenfumage naturel n'est pas applicable en IGH en raison de la hauteur et des contraintes aérauliques. C'est une spécificité technique des IGH par rapport aux ERP."
  },
  {
    theme: "UV 7 · Risques NRBC et plans de secours",
    q: "Qui met en place un PPI (Plan Particulier d'Intervention) ?",
    options: [
    ...
    correct: 2,
    explanation: "Le PPI est établi par le préfet du département pour les sites présentant des risques majeurs (sites SEVESO, installations nucléaires...). Il définit les mesures à prendre en cas d'accident grave débordant les limites du site. Le préfet coordonne les secours et déclenche le plan en cas de nécessité."
  },
  {
    theme: "UV 4 · ERP et IGH",
    q: "L'effectif d'un ERP de 2ème catégorie est compris entre :",
    options: [
      "301 et 700 personnes",
      "Plus de 1500 personnes",
      "Entre 701 et 1500 personnes",
      "Entre 1500 et 2500 personnes",
      "Aucune des réponses proposées"
    ],
    correct: 2,
    explanation: "Classification des ERP par effectif : 1ère catégorie = plus de 1500 personnes. 2ème catégorie = entre 701 et 1500 personnes. 3ème catégorie = entre 301 et 700 personnes. 4ème catégorie = jusqu'à 300 personnes (sauf 5ème cat.). 5ème catégorie = effectif sous le seuil minimal. À retenir : 2ème cat. = 701 à 1500."
  },
  {
    theme: "UV 7 · Risques NRBC et plans de secours",
    q: "Qu'est-ce qu'un plan ORSEC ? Un plan d' :",
    options: [
      "Organisation régionale de secours et des éléments de consultation",
      "Organisation de réactivité des secours",
      "Organisation des secours",
      "Aucune des réponses précédentes"
    ],
    correct: 2,
    explanation: "ORSEC = Organisation des SECours. C'est un plan départemental déclenché par le préfet pour faire face à tout événement de grande ampleur (catastrophe naturelle, accident industriel, événement terroriste). Il remplace et unifie les anciens plans de secours spécifiques depuis la loi de 2004."
  },
  {
    theme: "UV 2 · Missions de l'APS",
    q: "Si je trouve au cours d'une ronde un extincteur percuté, je dois :",
    options: [
      "Le signaler et l'emmener avec moi",
      "Le signaler et le coucher au sol",
      "Le signaler tout simplement",
      "Le recharger immédiatement"
    ],
    correct: 1,
    explanation: "Un extincteur percuté (déclenché, même partiellement) doit être couché au sol pour signaler visuellement qu'il est hors service, et signalé dans la main courante. Il ne faut pas l'emmener avec soi (risque de déplacement du matériel de sécurité), ni tenter de le recharger (opération réservée à un prestataire agréé). La position couchée est le signal conventionnel 'appareil inutilisable'."
  },
  {
    theme: "UV 2 · Missions de l'APS",
    q: "Des techniciens se présentent en journée au poste et souhaitent accéder au site sans badge. Vous devez :",
    options: [
      "Vous les laissez entrer sans formalités",
      "Vous téléphonez à la gendarmerie pour vérifier leur identité",
      "Vous les badgez après avoir contacté le chef de la sécurité"
    ],
    correct: 2,
    explanation: "Toute personne non badgée doit être traitée selon la procédure d'accueil : vérification de l'identité, contact avec le responsable du site ou le chef de la sécurité pour validation, puis attribution d'un badge visiteur temporaire. On ne laisse jamais entrer sans formalités, et on n'appelle pas la gendarmerie pour une simple vérification d'accès — c'est une procédure interne."
  },
  {
    theme: "UV 4 · ERP et IGH",
    q: "La main courante peut être tenue :",
    options: [
      "Sous forme de feuilles mobiles dans un classeur",
      "Emportée au domicile des APS",
      "En format papier ou électronique",
      "Uniquement sur support papier"
    ],
    correct: 2,
    explanation: "La main courante peut être tenue sur support papier ou électronique (informatisé), les deux formes sont légalement acceptées. Elle doit être chronologique (format 24h), non falsifiable, conservée sur le site, et disponible pour les autorités. Elle ne peut pas être emportée au domicile des agents."
  },
  {
    theme: "UV 5 · Incendie",
    q: "Parmi ces propositions, lesquels sont des moyens de secours au sens des articles MS ?",
    options: [
      "SSI – Ascenseurs – Escaliers protégés – Extincteurs",
      "Équipe SSIAP – Voie échelle – SSI – Moyens d'alerte",
      "Voie engin – Alarme évacuation – BAES – SSI",
      "Équipe SSIAP – Colonne sèche – Désenfumage – IFEA",
      "IFEA – Compartimentage – Désenfumage – SSI – Équipe SSIAP",
      "Aucune des réponses précédentes"
    ],
    correct: 3,
    explanation: "Les moyens de secours définis par les articles MS (Mesures de Sécurité) comprennent : équipe SSIAP, colonne sèche, désenfumage, IFEA (Installations Fixes d'Extinction Automatique). Les BAES, ascenseurs et escaliers protégés sont des moyens d'évacuation, pas des moyens de secours au sens strict des articles MS."
  },
  {
    theme: "UV 2 · Missions de l'APS",
    q: "Que doit faire un agent s'il trouve un objet illégal ou dangereux lors d'une palpation de sécurité ?",
    options: [
      "Confisquer l'objet et poursuivre la palpation",
      "Arrêter la palpation et alerter immédiatement les forces de l'ordre",
      "Ignorer l'objet s'il n'est pas trop dangereux",
      "Replacer l'objet et informer la personne"
    ],
    correct: 1,
    explanation: "Découverte d'un objet illégal ou dangereux lors d'une palpation : arrêter immédiatement la palpation, ne pas confisquer l'objet (ce n'est pas une prérogative de l'APS), alerter les forces de l'ordre (17). L'APS n'est pas habilité à saisir des objets ni à poursuivre une palpation en présence d'un danger. Sa mission s'arrête à l'alerte des autorités compétentes."
  },
  {
    theme: "UV 3 · Tenue et présentation",
    q: "Dans quel cas, lors d'une activité de gardiennage, le port de la tenue n'est pas obligatoire pour un APS ?",
    options: [
      "Une activité de gardiennage",
      "En tant qu'agent 'prévol'",
      "Une activité de surveillance de nuit",
      "La surveillance d'un site militaire"
    ],
    correct: 1,
    explanation: "L'agent 'prévol' (agent de sûreté aéroportuaire effectuant des missions d'inspection-filtrage) peut, dans certaines configurations spécifiques liées aux exigences de la sûreté aérienne, exercer sans la tenue standard de l'APS. C'est l'une des rares exceptions au port obligatoire de la tenue réglementaire."
  }
];

// Fusionner dans questionsQCM
if (typeof questionsQCM !== 'undefined') {
  questionsFormation.forEach(q => questionsQCM.push(q));
}
