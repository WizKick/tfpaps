...
const questionsQCM = [
  ...
  // ========== ARMES & CATÉGORIES ==========
  {
    ...
    correct: 2,
    explanation: "Catégorie D = armes en vente libre (majeur). Note : la bombe lacrymogène ≤100ml et la matraque télescopique sont aussi catégorie D."
  },
  {
    theme: "Armes",
...
const questionsOral = [
  ...
  },
  {
    ...
    a: "La prise de service commence à l'extérieur du bâtiment : on s'assure de la vacuité des voies engins et échelles, des bouches et poteaux incendie, et de la présence du plan d'intervention à l'entrée du bâtiment.\n\nUne fois au PC de Sécurité :\n• Appel à l'astreinte\n• Vérification du matériel (présence, quantité, fonctionnement)\n• Lecture des consignes journalières\n• Contrôle du SSI (tension, voyants, test de signalisation)\n• Main courante : lecture et ouverture"
  },
  {
    q: "Définition du SSI ?",
